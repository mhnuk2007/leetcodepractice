...
/**
 * Implementation of the Bellman-Ford Algorithm using an Edge List.
 *
 * <p><b>Definition:</b>
 ...
 * <p><b>Key Points:</b>
 * <ul>
 *     <li>An edge list is the natural representation — the algorithm is defined
 *         as "relax every edge {@code V - 1} times", which maps directly to
 *         iterating a flat list of edges</li>
 ...
 * <p><b>Space Complexity:</b> O(V + E) — dist array + edge list</p>
 */
public class BellmanFordAlgorithmEdge {
     ...
     *
     * <p>Performs {@code V - 1} relaxation passes over all edges. A
     * {@code V}-th pass that still relaxes any edge confirms a negative
     * weight cycle reachable from {@code src}.
     *
     * @param V     number of vertices
     * @param edges list of all directed weighted edges
     * @param src   source vertex
     */
    ...
    public static void main(String[] args) {
        ...
        edges1.add(new Edge(1, 2, -4));
        edges1.add(new Edge(1, 4, -1));
        edges1.add(new Edge(2, 3,  2));
        edges1.add(new Edge(3, 4,  4));
        ...
        edges2.add(new Edge(1, 3, 7));
        edges2.add(new Edge(2, 4, 3));
        edges2.add(new Edge(3, 5, 1));
        edges2.add(new Edge(4, 5, 5));
        ...
        edges4.add(new Edge(1, 2, -3));
        edges4.add(new Edge(2, 1,  1));

        System.out.println("\nExample 4 (negative weight cycle):");
        bellmanFord(V4, edges4, 0);
        ...
        edges5.add(new Edge(0, 1, 5));

        System.out.println("\nExample 5 (unreachable node, src=0):");
        bellmanFord(V5, edges5, 0);
