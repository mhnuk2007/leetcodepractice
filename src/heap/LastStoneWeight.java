...
What was added:
Class-level Javadoc — problem statement, approach, and complexity
lastStoneWeight Javadoc — param and return contract
check helper — reusable comparator that prints PASS/FAIL with label, actual, and expected
10 test cases covering: LeetCode examples (TC1–2), equal/unequal pairs (TC3–4), all-equal (TC5), all-ones odd count (TC6), sorted descending (TC7), max constraint values (TC8), one dominant stone (TC9), reversed pair (TC10)
