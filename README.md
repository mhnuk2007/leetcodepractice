# Java DSA — 180+ LeetCode Problems & 330 Java DSA Files
...
Welcome! This repository contains **180+ tracked LeetCode solutions and 330 Java DSA files organized by algorithm patterns**.
...
```
src/arrays/
├── basics/                [5 files  — ContainsDuplicate, PascalsTriangle, PascalsTriangleII, PlusOne, RichestCustomerWealth]
├── rotation/               [4 files  — CircularArrayLoop, NextPermutation, RotateArray, RotateFunction]
├── prefix/                 [5 files  — FindPivotIndex, ProductOfArrayExceptSelf, RunningSum1d, TrappingRainWater, TrappingRainWaterPrefix]
├── greedy/                 [6 files  — ArrayPartition, BestTimeToBuyAndSellStock, LargestNumberTwiceOthers, MajorityElement, MaxProfit, MergeIntervals]
├── matrix/                 [4 files  — SearchInRotatedSortedArray, SetMatrixZeroes, SpecialPositionsInBinaryMatrix, SpiralMatrix]
└── advanced/                [2 files  — CountInversions, KadaneAlgorithm]
```

### 📁 Binary Search (3 subcategories · 12 files)
```
src/binarysearch/
├── basics/                [4 files — BinarySearch, FirstBadVersion, SearchInsert, SqrtX]
├── rotated/                [4 files — FindMinRotatedArray, FindPeakElement, SearchRotatedSortedArray, SearchRotatedSortedArrayII]
├── advanced/                [3 files — FindKClosestElements, FirstAndLastPosition, SearchIn2DMatrix]
...
```
src/dp/
├── linear/                 [10 files — ClimbingStairsDpArray, ClimbingStairsDpMap, DeleteAndEarn, HouseRobberArray, HouseRobberMap,
│                                        MaxScoreMulOps, MinCostClimbingStairs, Tribonacci, TribonacciBottomUp, TribonacciTopDown]
├── knapsack/               [6 files  — CoinChange, CoinChangeII, Knapsack01, PartitionEqualSubSetSum, TargetSum, UnboundedKnapsack]
├── memoization/             [5 files  — BottomUpSum, FibDP, FibDP2, Fibonacci, TopDownSum]
...
```
src/graph/
├── traversal/              [16 files — AdjacencyMatrix, AllPaths, AllPathsSourceTarget, BfsTraversal, BFSTraversalInGraph,
...
├── topological/             [13 files — CourseSchedule, CourseScheduleCycleDetection, CourseScheduleDfs, CourseScheduleDFSOptimal,
...
├── mst/                    [8 files  — Kruskal, KruskalAlgorithm, MaximizeSpanningTreeStability, MinCostToConAllPoints,
│                                        MinCostToConAllPointsOpt, MinCostToConnectAllPoints, PrimAlgorithm, PrimsAlgorithm]
├── shortestpath/            [8 files  — BellmanFordAdjacencyList, BellmanFordAlgorithm, BellmanFordAlgorithmEdge,
│                                        CheapestFlightsWithinKStops, DijkstraAdjacencyList, DijkstraAlgorithm, NetworkDelayTime, WeightedGraph]
├── cycles/                 [7 files  — CriticalConInANet, CycleDetectionDirectedGraph, CycleDetectionUndirectedGraph,
...
└── unionfind/               [5 files  — DisjointSetUnion, DSU, PathExistenceQueries, PathExistenceQueriesDSU, RedundantConnection]
```

### 📁 Strings (3 active subcategories + 1 reserved · 26 files)
```
src/strings/
├── basic/                  [10 files — AddBinary, AddStrings, BinaryGap, JavaStringTokens, ReverseString,
│                                        ReverseWordsInString, ReverseWordsInStringII, ReverseWordsInStringIII, RotatingString, SplitString]
├── pattern/                 [9 files  — Anagram, IsomorphicStrings, Palindrome, PalindromeI, PalindromeII,
│                                        SmallestAndLargestSub, ValidAnagram, ValidPalindrome, ValidWordAbbreviation]
├── advanced/                [7 files  — FindIndexOfFirstOccurrence, LongestSubstringWithoutRepeatingCharacters,
│                                        MinChangesAlternatingBinaryString, MinCostToConvertStringI, MinCostToConvertStringII,
│                                        PartitionDeciBinary, PartitioningIntoMinDeciBinaryNumbers]
└── encoding/                [0 files — Reserved]
```

### 📁 Linked List (5 subcategories · 17 files)
```
src/linkedlist/
├── basic/                  [4 files  — DeleteNode, ListNode, MyLinkedList, SinglyLinkedList]
├── traversal/               [2 files  — MaximumTwinSumOfLinkedList, ReverseLinkedList]
├── operations/              [4 files  — AddTwoNumbers, DesignLinkedList, MergeTwoSortedLists, RemoveNthNodeFromEnd]
├── cycles/                 [2 files  — LinkedListCycle, LinkedListCycleII]
├── advanced/                [3 files  — LinkedListsIntersection, PalindromeLinkedList, SplitCircularLinkedList]
└── (root)                  [1 file   — Main.java]
```

### 📁 Tree (3 subcategories · 18 files)
```
src/tree/
├── traversal/               [5 files  — BinaryTreeInorder, BinaryTreePostorder, BinaryTreePreorder, LevelOrderTraversal, RightSideView]
├── basic/                   [5 files  — CountNodes, InvertBinaryTree, MaxDepth, MyBinaryTree, SameTree]
└── advanced/                 [8 files  — BalancedBinaryTree, ConstructBinaryTree, ConstructBinaryTree106, DiameterOfBinaryTree,
│                                         LowestCommonAncestorOfBinaryTree, LowestCommonAncestorOfBST, PathSum, PathSumII]
```

### 📁 Other Categories
```
src/arrays101/              [22 files — LeetCode Arrays 101 Beginner Track]
src/recursion/              [29 files — Recursion fundamentals + backtracking problems]
src/heap/                   [13 files — KthFactorOfN, KthLargestElement, KWeakestRows, LastStoneWeight, Main, MaxHeap,
                                         MedianFromDataStream, MedianFromDataStreamOptimal, MergeKSortedLists, MinHeap,
                                         TopKFrequentElements, Twitter, UglyNumberII]
src/stack/                  [11 files — ArrayListStack, ArrayStack, DailyTemperatures, LinkedListStack, MinStack,
                                         MinStackLinkedList, NextGreaterElement, NextGreaterElementII, ReversePolishNotation,
                                         ValidParenthesis, ValidParenthesisMap]
src/queue/                  [9 files  — ArrayListQueue, ArrayQueue, LinkedListQueue, MovingAverage, MyCircularQueue,
                                         MyCircularQueueArrayList, MyCircularQueueLinkedList, MyQueueUsingStacks, MyStackUsingQueue]
src/sortalgorithms/         [13 files — BubbleSort, BubbleSortRec, CountSmallerAfterSelf, InsertionSort, InsertionSortRec, MergeSort,
                                         MergeSortRec, PatternsViaRecursion, ReversePairs, SelectionSort, SelectionSortRec, SortColors, TwoColorSort]
src/twopointer/             [10 files — AppendCharacters, ContainerWithMostWater, FindTheDuplicateNumber, FourSum, HappyNumber,
                                         LengthOfLoop, MiddleOfLinkedList, StrobogrammaticNumber, ThreeSum, TwoSum, TwoSumII]
src/hashing/                [5 files  — ContainsDuplicatesII, FirstUniqueCharacter, IntersectionOfArrays, IntersectionOfArraysII, MinimumIndexSum]
src/dailychallenges/        [6 files  — 6 daily challenge problems]
src/slidingwindow/          [9 files  — DynamicWindow, LongestSubstringWithoutRepeatingCharacters, MaximumAverageSubarrayI,
...
src/map/designhashmap/      [1 file   — MyHashMap]
src/math/                   [5 files  — GCDOfOddEvenSums, RotatedDigits, SortedPairGCDQueries, SumOfGCDOfFormedPairs, UglyNumber]
...
> Last updated: July 19, 2026. File count is 330 (verified from directory tree). Progress tracker corrected for LC 105, LC 1770, and LC 2461. Graphs section reflects completed concept files plus LC 695. Trie updated after LC 208 and LC 212 completion. DP updated with 0-1 Knapsack, Unbounded Knapsack, Longest Common Substring, 53, 198, 416, 494, 518, 740, 746, 1137, 1143, 1770, 3129, 3130, 95, and 96. Trees updated with 105, 106, 112, 113, 235, 236. Strings updated with 796.

| #   | Category              | Done    | Total   | Progress             |
|-----|-----------------------|---------|---------|----------------------|
| 1   | Arrays & Two Pointers | 55      | 55      | `██████████` 100%    |
| 2   | Sliding Window        | 7       | 19      | `████░░░░░░` 37%     |
| 3   | Strings               | 17      | 28      | `██████░░░░` 61%     |
| 4   | HashMap / HashSet     | 11      | 23      | `█████░░░░░` 48%     |
| 5   | Binary Search         | 13      | 31      | `████░░░░░░` 42%     |
| 6   | Linked List           | 13      | 26      | `█████░░░░░` 50%     |
| 7   | Stack & Queue         | 12      | 31      | `████░░░░░░` 39%     |
| 8   | Heap / Priority Queue | 10      | 22      | `█████░░░░░` 45%     |
| 9   | Trees                 | 19      | 50      | `████░░░░░░` 38%     |
| 10  | Backtracking          | 16      | 23      | `███████░░░` 70%     |
| 11  | Graphs                | 19      | 29      | `███████░░░` 66%     |
| 12  | Dynamic Programming   | 20      | 49      | `████░░░░░░` 41%     |
| 13  | Greedy                | 3       | 14      | `██░░░░░░░░` 21%     |
| 14  | Trie                  | 2       | 5       | `████░░░░░░` 40%     |
| 15  | System Design / LLD   | 0       | 3       | `░░░░░░░░░░` 0%      |
| 16  | Bit Manipulation      | 5       | 13      | `████░░░░░░` 38%     |
...
| —    | Count Inversions                                | —          | ✅      | Merge Sort / Divide & Conquer     | —                        |
| —    | Reverse Pairs                                   | —          | ✅      | Merge Sort / Divide & Conquer     | —                        |
...
| 396  | Rotate Function                                 | Medium     | ✅      | Array / Math                      | A, G                     |
| 941  | Valid Mountain Array                            | Easy       | ✅      | Array Traversal                   | A                        |
| 977  | Squares of a Sorted Array                       | Easy       | ✅      | Two Pointers                      | A, G, M                  |
...
| 3658 | GCD of Odd and Even Sums                        | Easy       | ✅      | Math                              | G                        |
| 3742 | Maximum Path Score in a Grid                    | Medium     | ✅      | DP / Grid                         | G                        |
| 3867 | Sum of GCD of Formed Pairs                      | Medium     | ✅      | Math                              | G                        |

---

### 2. Sliding Window — 7/19
...
| 240  | Search a 2D Matrix II                                   | Medium     | ✅      | Binary Search | A, G, B              |
...
| 994  | Rotting Oranges                   | Medium     | ✅      | BFS (multi-source)     | A, G, M, Meta            |
| 1091 | Shortest Path in Binary Matrix    | Medium     | ⬜      | BFS                    | A, G, Meta, B            |

---

### 8. Heap / Priority Queue — 10/22
...
| 263  | Ugly Number                                   | Easy       | ✅      | Heap / Math        | G, A                  |
...
| Cycle Detection — Directed (BFS + DFS)   | ✅      | `CycleDetectionDirectedGraph.java`                            |
| Cycle Detection in 2D Grid               | ✅      | `DetectCycleIn2DGrid.java`                                    |
...
| Bellman-Ford Algorithm                   | ✅      | `BellmanFordAlgorithm.java` · `BellmanFordAlgorithmEdge.java` |
| Weighted Graph                           | ✅      | `WeightedGraph.java`                                          |
...
| 1192 | Critical Connections in a Network   | Hard       | ✅      | Tarjan's / Bridges           | A, G, B              | —       |
| 1559 | Detect Cycles in 2D Grid            | Medium     | ✅      | DFS                          | G                    | —       |
...
| 788  | Rotated Digits                      | Medium     | ✅      | Bit Manipulation | A, G       |
...
├── arrays101/           # LeetCode Arrays 101 explore card (22 files)
...
├── linkedlist/          # Linked list problems (17 files, 5 subcategories)
...
├── strings/             # String problems (26 files, 3 active subcategories)
...
**Total: 330 Java files** (verified July 19, 2026 from `tree /f` output)
...
*Last updated: July 19, 2026 — file count and folder statistics refreshed against the latest repository tree (330 files); problem-set table formatting and alignment corrected throughout.*