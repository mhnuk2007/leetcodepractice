...
> ✨ Updated July 2026: this repository now contains 331 Java files under src, with verified solutions such as CountSmallerAfterSelf in [src/sortalgorithms/CountSmallerAfterSelf.java](src/sortalgorithms/CountSmallerAfterSelf.java) and CountInversions in [src/arrays/advanced/CountInversions.java](src/arrays/advanced/CountInversions.java).
